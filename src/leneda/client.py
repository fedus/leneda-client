...
import json
from .models import MeteringData, AggregatedMeteringData
...
class LenedaClient:
    ...
    def _make_request(self, endpoint: str, method: str = "GET", params: Dict[str, Any] = None, 
    ...
    def get_time_series(self, metering_point_code: str, obis_code: str,
                       start_date_time: Union[str, datetime], 
                       end_date_time: Union[str, datetime]) -> MeteringData:
        """
        ...
        return MeteringData.from_dict(response_data, metering_point_code=metering_point_code, obis_code=obis_code)
    
    def get_aggregated_time_series(self, metering_point_code: str, obis_code: str,
                                  start_date: Union[str, datetime], 
                                  end_date: Union[str, datetime],
                                  aggregation_level: str = "Day",
                                  transformation_mode: str = "Accumulation") -> AggregatedMeteringData:
        """
    ...
    def request_metering_data_access(self, metering_point_code: str) -> Dict[str, Any]:
        ...
        data = {
            "meteringPointCode": metering_point_code
        }
