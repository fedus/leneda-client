...
OBIS_CODES: Dict[str, ObisCodeInfo] = {
    ...
    GasConsumption.STANDARD_VOLUME: ObisCodeInfo(
        GasConsumption.STANDARD_VOLUME, "Nm³", "Consumption", "Measured consumed standard volume"
    ),
