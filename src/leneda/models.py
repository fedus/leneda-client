...
class MeteringData:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any], metering_point_code: str = "", obis_code: str = "") -> 'MeteringData':
...
class AggregatedMeteringData:
    ...
    @classmethod
    def from_dict(cls, data: Dict[str, Any], metering_point_code: str = "", obis_code: str = "",
                 aggregation_level: str = "", transformation_mode: str = "") -> 'AggregatedMeteringData':
        ...
        try:
            ...
            return cls(
                unit=data.get('unit', ''),
                aggregated_time_series=time_series
            )
        except Exception as e:
